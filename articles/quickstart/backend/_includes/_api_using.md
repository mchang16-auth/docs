...
!<a href="/media/articles/server-apis/using/private-unauthorized.png" target="_blank">Response for unauthorized API request</a>
...
!<a href="/media/articles/server-apis/using/private.png" target="_blank">Response for authorized API request</a>
...
!<a href="/media/articles/server-apis/using/private-scoped.png" target="_blank">Response for scoped API request</a>

If the required scope is not present, the API returns a 403 HTTP Status (Forbidden):

!<a href="/media/articles/server-apis/using/private-scoped-forbidden.png" target="_blank">Response for forbidden scoped API request</a>